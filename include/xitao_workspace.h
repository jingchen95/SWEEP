...
namespace xitao {   
  ...
  extern long avail_freq[NUMSOCKETS][NUM_AVAIL_FREQ];
  extern long avail_ddr_freq[NUM_DDR_AVAIL_FREQ];
  extern long cur_ddr_freq;
  extern long cur_freq[XITAO_MAXTHREADS];
  extern int cur_ddr_freq_index;
  extern int cur_freq_index[XITAO_MAXTHREADS];
